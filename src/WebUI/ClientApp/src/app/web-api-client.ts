...
export interface IBikesClient {
    get(): Observable<BikesVm>;
...
export class BikesClient implements IBikesClient {
    ...
    get(): Observable<BikesVm> {
        let url_ = this.baseUrl + "/api/Bikes";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<BikesVm>;
                }
            } else
                return _observableThrow(response_) as any as Observable<BikesVm>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<BikesVm> {
        ...
        if (status === 200) {
            ...
            result200 = BikesVm.fromJS(resultData200);
...
export class BikesVm implements IBikesVm {
    bikes?: BikeDto[];
    manufacturers?: ManufacturerDto[];

    constructor(data?: IBikesVm) {
        if (data) {
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["bikes"])) {
                this.bikes = [] as any;
                for (let item of _data["bikes"])
                    this.bikes!.push(BikeDto.fromJS(item));
            }
            if (Array.isArray(_data["manufacturers"])) {
                this.manufacturers = [] as any;
                for (let item of _data["manufacturers"])
                    this.manufacturers!.push(ManufacturerDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): BikesVm {
        data = typeof data === 'object' ? data : {};
        let result = new BikesVm();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (Array.isArray(this.bikes)) {
            data["bikes"] = [];
            for (let item of this.bikes)
                data["bikes"].push(item.toJSON());
        }
...
export interface IBikesVm {
    bikes?: BikeDto[];
    manufacturers?: ManufacturerDto[];
}

export class BikeDto implements IBikeDto {
    id?: number;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.frameSize = _data["frameSize"];
            this.price = _data["price"];
        }
    }

    static fromJS(data: any): BikeDto {
        data = typeof data === 'object' ? data : {};
        let result = new BikeDto();
        result.init(data);
        return result;
    }
